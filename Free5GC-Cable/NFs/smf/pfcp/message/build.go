...
func BuildPfcpUpfReportRequest() (pfcp.PFCPUPFReportRequest, error) {
	//构造request内容
	msg := pfcp.PFCPUPFReportRequest{}
...
func BuildPduSessionDataReportRequest() (pfcp.PDUSessionDataReportRequest, error) {
	//构造request内容
	msg := pfcp.PDUSessionDataReportRequest{}
...
/*
func BuildPfcpUpfReportResponse(cause pfcpType.Cause) (pfcp.PFCPUPFReportResponse, error) {
	//构造response内容，如果需要的话
}
*/
...
func BuildPDUSessionReleaseFromSMFResponse(cause pfcpType.Cause) (pfcp.PDUSessionReleaseFromSMFResponse, error) {
	msg := pfcp.PDUSessionReleaseFromSMFResponse{}
